...
import (
	monotonicclock "github.com/fermyon/spin-go-sdk/internal/wasi/clocks/v0.2.0/monotonic-clock"
	ioerror "github.com/fermyon/spin-go-sdk/internal/wasi/io/v0.2.0/error"
	"github.com/fermyon/spin-go-sdk/internal/wasi/io/v0.2.0/poll"
...
func (self OutgoingRequest) SetAuthority(authority cm.Option[string]) (result cm.BoolResult) {
	...
	result = cm.Reinterpret[cm.BoolResult]((uint8)((uint32)(result0)))
	return
}
